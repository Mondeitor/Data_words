...
void button_buscar_TextView(GtkWidget *widget, CCPTextBuffer *stuff) 
{
    ...
    //Si has introducido en el texview entre 1 y 5000 caŕacteres se ejecutará la condición
    if(sizeText >= 0 and sizeText <= 5000)
    {
        ...
        for(int i = 0; i < sizeText; i++)
        {
            ...
            //Contanbilizar los saltos de línea que hay
        ...
        if(sizeWordsV >= 0 and sizeWordsV <= 5000)
        {
            ...
            int cont15 = 0;
            int cont16 = 1;
            char palabrasQueNoEstanEnElFichero[50000];
            int pos = 0;
            int pos2 = 0;
            ...
            char palabras2[250];
            char palabras3[250];
            char palabrasSinRepetir[5000];
            char palabrasSinRepetirSinAsteriscosQueNoEstanEnElFichero[5000];
            int k2;
            char palabrasSinRepetirSinSaltosDeLinea[5000];
            int x1 = 0;
            ...
            short numDigitos2;
            char sizePalabrasNoEncontradas[5000];
            int contador2 = 0;
            ...
            gtk_label_set_text(GTK_LABEL (stuff->widLabel2), sizePalabrasQueBusco);
...
void button_listar_Palabras_Fichero(GtkWidget *widget, CCPTextBuffer2 *stuff) 
{
    ...
    //2º ARCHIVO 
	if((listadoOrdenado=fopen("/home/pi/Desktop/Proyectos Geany/C++/Data_words/Data/idiomaAlemánOrdenado.dat", "wb+"))==NULL)//antes r+b, se pone wb+ para que al llamar al método listar_palabras_fichero se sobreescribe el archivo
	{
		if((listadoOrdenado=fopen("/home/pi/Desktop/Proyectos Geany/C++/Data_words/Data/idiomaAlemánOrdenado.dat", "ab+"))==NULL)//antes era a+b pero este escribe datos al final del fichero
		{
...
void button_add_TextView(GtkWidget *widget, CCPTextBuffer3 *stuff)
{
    ...
    if(sizeText >= 0 and sizeText <= 5000)
    {
        ...
        if(sizeWordsV >= 0 and sizeWordsV <= 5000)
        {
            ...
            gtk_label_set_text(GTK_LABEL (stuff->widLabel7), sizePalabrasQueBusco);
...
int main(int argc, char **argv)
{
	 ...
	 * **/
	if((listado=fopen("/home/pi/Desktop/Proyectos Geany/C++/Data_words/Data/idiomaAlemán.dat", "rb+"))==NULL)//antes r+b
	{
		if((listado=fopen("/home/pi/Desktop/Proyectos Geany/C++/Data_words/Data/idiomaAlemán.dat", "ab+"))==NULL)//antes era a+b pero este escribe datos al final del fichero
		{
			printf("No se puede crear el fichero");
		}
		else
    ...
    GtkWidget *window, *notebook, *titlePage1, *titlePage2, *titlePage3, *titlePage4, *titlePage5, *titlePage6, *titlePage7;
    GtkWidget *label1Page1, *label2Page1, *label3Page1, *label4Page1, *label5Page1, *label6Page1, *label7Page1, *label8Page1, *label9Page1, *label10Page1,
              *label11Page1, *label1Page2, 
              *label2Page2, *label3Page2, *label4Page2, *label5Page2, *label1Page3, *label2Page3, *label3Page3, *label6Page3, *label1Page4,
              ...
              *label9Page5, *label10Page5, *label11Page5, *label1Page6, *label2Page6, *label3Page6, *label4Page6, *label5Page6, *label1Page7, *label2Page7, 
              *label3Page7, *label6Page7;
    GtkWidget *page1, *page2, *page3, *page4, *page5, *page6, *page7;
    GtkWidget *entry1, *entry2, *entry3, *entry4; 
    GtkWidget *textViewMultilinea1, *textViewMultilinea2, *textViewMultilinea3, *textViewMultilinea4, *textViewMultilinea5, *textViewMultilinea6, *textViewMultilinea7;
    ...
    GtkWidget *scroll1, *scroll2, *scroll3, *scroll4, *scroll5, *scroll6, *scroll7;
    GtkWidget *vbox1Page1, *vbox2Page1, *vbox3Page1, *hbox1Page1, *hbox2Page1, *hbox3Page1, *hbox4Page1, *hbox5Page1, *hbox6Page1, *hbox7Page1, *hbox8Page1, 
              *hbox9Page1, *hbox10Page1, *vbox4Page1, *vbox5Page1, *hbox1Page3, *hbox2Page3, *hbox4Page3, *vbox1Page3, *vbox2Page3, *vbox3Page3, *vbox1Page4, 
              ...
              *hbox10Page5, *vbox1Page5, *vbox2Page5, *vbox3Page5, *vbox4Page5, *vbox5Page5, *hbox1Page7, *hbox2Page7, *hbox4Page7, *vbox1Page7, *vbox2Page7, 
              *vbox3Page7;
    GtkWidget *layerFixed;
	
    GtkTextBuffer *text1, *text2, *text3, *text4, *text5, *text6, *text7;
    
    GtkTextIter iter1, iter2, iter3, iter4, iter5, iter6, iter7;
    
    GtkCssProvider* cssProviderLog;
    ...
    scroll7 = gtk_scrolled_window_new(NULL, NULL);
    ...
    /**Establecemos el color del texto entre otras cosas**/
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #4dd5ff;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea1);
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #66ff33;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea2);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    ...
    gtk_box_pack_start(GTK_BOX(hbox7Page1), label9Page1, FALSE, FALSE, 5);//label10Page1
    ...
    gtk_box_pack_start(GTK_BOX(vbox5Page1), hbox9Page1, FALSE, FALSE, 5);
    ...
    gtk_box_pack_start(GTK_BOX(vbox2Page1), hbox4Page1, FALSE, FALSE, 5);//aquí otro
    gtk_box_pack_start(GTK_BOX(vbox2Page1), hbox5Page1, FALSE, FALSE, 5);//aquí otro
    gtk_box_pack_start(GTK_BOX(vbox2Page1), hbox6Page1, FALSE, FALSE, 5);//aquí otro
    ...
    //Tercera página
    page3 = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 1);
    titlePage3 = gtk_label_new("Words I am looking for");
    layerFixed = gtk_fixed_new();
    label1Page3 = gtk_label_new("                   ");
    label2Page3 = gtk_label_new("Number of words:");
    label3Page3 = gtk_label_new("");
    
    
    textViewMultilinea3 = gtk_text_view_new();
    gtk_container_add(GTK_CONTAINER(scroll3), textViewMultilinea3);
    gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scroll3), GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);  
    gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scroll3), GTK_SHADOW_ETCHED_IN);
   
    text3 = gtk_text_view_get_buffer(GTK_TEXT_VIEW(textViewMultilinea3));
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #ffa31a;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea3);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    
    gtk_text_buffer_get_iter_at_offset(text3, &iter3, 0);
    gtk_text_view_set_editable(GTK_TEXT_VIEW(textViewMultilinea3), FALSE);
    
    /**Establecemos el color de los widgets del fondo de los textView**/
    const GdkRGBA colorBakgroundTextView3 = {0, 0, 0, 0.59};   
  
    gtk_widget_override_background_color(textViewMultilinea3, GTK_STATE_FLAG_NORMAL, &colorBakgroundTextView3);
    /**Establecemos el color y tamaño del texto del textview**/
    
    
     /**Metemos los widgets en cajas horizontales y vericales y luego en el page1**/
    hbox1Page3 = gtk_hbox_new(TRUE, 5);
    hbox2Page3 = gtk_hbox_new(FALSE, 5);
    hbox4Page3 = gtk_hbox_new(FALSE, 5);
    vbox1Page3 = gtk_vbox_new(FALSE, 5);
    vbox2Page3 = gtk_vbox_new(FALSE, 5);
    vbox3Page3 = gtk_vbox_new(FALSE, 5);
    
    
    //Metemos esto para ocupar espacio en la ventana
    label6Page3 = gtk_label_new("                                                     ");
    gtk_box_pack_start(GTK_BOX(hbox4Page3), label6Page3, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(vbox1Page3), hbox4Page3, FALSE, FALSE, 5);
    
    
    //Metemos el label en una columna
    gtk_box_pack_start(GTK_BOX(vbox2Page3), label1Page3, FALSE, FALSE, 5);
    
    //Metemos el textfield en otra columna
    gtk_box_pack_start(GTK_BOX(vbox2Page3), scroll3, TRUE, TRUE, 5);
    
    //Metemos los 4 label en hbox y luego lo metemos en un vbox
    gtk_box_pack_start(GTK_BOX(hbox2Page3), label2Page3, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(hbox2Page3), label3Page3, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(vbox3Page3), hbox2Page3, FALSE, FALSE, 5);
    

    //Ahora metemos todo en una fila
    gtk_box_pack_start(GTK_BOX(hbox1Page3), vbox1Page3, FALSE, TRUE, 3);
    gtk_box_pack_start(GTK_BOX(hbox1Page3), vbox2Page3, FALSE, TRUE, 3);
    gtk_box_pack_start(GTK_BOX(hbox1Page3), vbox3Page3, FALSE, TRUE, 3);
   
   
    /**Lo añadimos al page6**/
    gtk_container_add(GTK_CONTAINER(page3), hbox1Page3);
   
    /**Lo metemos en el notebook**/
    gtk_notebook_append_page(GTK_NOTEBOOK(notebook), page3, titlePage3);
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #ffa31a;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea4);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #4dd5ff;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea5);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #66ff33;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea6);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    ...
    //Septima página
    page7 = gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 1);
    titlePage7 = gtk_label_new("Words that I add");
    layerFixed = gtk_fixed_new();
    label1Page7 = gtk_label_new("                   ");
    label2Page7 = gtk_label_new("Number of words:");
    label3Page7 = gtk_label_new("");
    
    
    textViewMultilinea7 = gtk_text_view_new();
    gtk_container_add(GTK_CONTAINER(scroll7), textViewMultilinea7);
    gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scroll7), GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);  
    gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scroll7), GTK_SHADOW_ETCHED_IN);
   
    text7 = gtk_text_view_get_buffer(GTK_TEXT_VIEW(textViewMultilinea7));
    ...
    gtk_css_provider_load_from_data(cssProviderLog,
                                    ...
                                    "color: #ffa31a;"
                                    "}",-1, NULL);
    context = gtk_widget_get_style_context(textViewMultilinea7);
    gtk_style_context_add_provider(context,
                                GTK_STYLE_PROVIDER(cssProviderLog),
                                GTK_STYLE_PROVIDER_PRIORITY_USER);
    /**Establecemos el color del texto entre otras cosas**/
    
    gtk_text_buffer_get_iter_at_offset(text7, &iter7, 0);
    gtk_text_view_set_editable(GTK_TEXT_VIEW(textViewMultilinea7), FALSE);
    
    /**Establecemos el color de los widgets del fondo de los textView**/
    const GdkRGBA colorBakgroundTextView7 = {0, 0, 0, 0.59};   
  
    gtk_widget_override_background_color(textViewMultilinea7, GTK_STATE_FLAG_NORMAL, &colorBakgroundTextView7);
    /**Establecemos el color y tamaño del texto del textview**/
    
    
     /**Metemos los widgets en cajas horizontales y vericales y luego en el page7**/
    hbox1Page7 = gtk_hbox_new(TRUE, 5);
    hbox2Page7 = gtk_hbox_new(FALSE, 5);
    hbox4Page7 = gtk_hbox_new(FALSE, 5);
    vbox1Page7 = gtk_vbox_new(FALSE, 5);
    vbox2Page7 = gtk_vbox_new(FALSE, 5);
    vbox3Page7 = gtk_vbox_new(FALSE, 5);
    
    
    //Metemos esto para ocupar espacio en la ventana
    label6Page7 = gtk_label_new("                                                     ");
    gtk_box_pack_start(GTK_BOX(hbox4Page7), label6Page7, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(vbox1Page7), hbox4Page7, FALSE, FALSE, 5);
    
    //Metemos el label en una columna
    gtk_box_pack_start(GTK_BOX(vbox2Page7), label1Page7, FALSE, FALSE, 5);
    
    //Metemos el textfield en otra columna
    gtk_box_pack_start(GTK_BOX(vbox2Page7), scroll7, TRUE, TRUE, 5);
    
    //Metemos los 4 label en hbox y luego lo metemos en un vbox
    gtk_box_pack_start(GTK_BOX(hbox2Page7), label2Page7, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(hbox2Page7), label3Page7, FALSE, FALSE, 5);
    gtk_box_pack_start(GTK_BOX(vbox3Page7), hbox2Page7, FALSE, FALSE, 5);
    

    //Ahora metemos todo en una fila
    gtk_box_pack_start(GTK_BOX(hbox1Page7), vbox1Page7, FALSE, TRUE, 3);
    gtk_box_pack_start(GTK_BOX(hbox1Page7), vbox2Page7, FALSE, TRUE, 3);
    gtk_box_pack_start(GTK_BOX(hbox1Page7), vbox3Page7, FALSE, TRUE, 3);
   
   
    /**Lo añadimos al page7**/
    gtk_container_add(GTK_CONTAINER(page7), hbox1Page7);
   
    /**Lo metemos en el notebook**/
    gtk_notebook_append_page(GTK_NOTEBOOK(notebook), page7, titlePage7);
    ...
    g_signal_connect(G_OBJECT(buttonLimpiar1), "clicked", G_CALLBACK(button_limpiar_TextView), text3);
    ...
    g_signal_connect(G_OBJECT(buttonLimpiar1), "clicked", G_CALLBACK(button_limpiar_Label), label3Page3);
    
    g_signal_connect(G_OBJECT(buttonLimpiar1), "clicked", G_CALLBACK(button_limpiar_Label), label8Page1);
    
    
    CCPTextBuffer copying1 = {text1, text2, text3, label4Page1, label3Page3, label6Page1, label8Page1};
    ...
    CCPTextBuffer3 copying6 = {text5, text6, text7, label4Page5, label6Page5, label3Page7, label8Page5};
